...
public interface TempConvertSoap {
    ...
    @RequestWrapper(localName = "CelsiusToFahrenheit", targetNamespace = "https://www.w3schools.com/xml/", className = "org.grails.cxf.soap.convert.CelsiusToFahrenheit")
    @ResponseWrapper(localName = "CelsiusToFahrenheitResponse", targetNamespace = "https://www.w3schools.com/xml/", className = "org.grails.cxf.soap.convert.CelsiusToFahrenheitResponse")
    ...
    @RequestWrapper(localName = "FahrenheitToCelsius", targetNamespace = "https://www.w3schools.com/xml/", className = "org.grails.cxf.soap.convert.FahrenheitToCelsius")
    @ResponseWrapper(localName = "FahrenheitToCelsiusResponse", targetNamespace = "https://www.w3schools.com/xml/", className = "org.grails.cxf.soap.convert.FahrenheitToCelsiusResponse")
