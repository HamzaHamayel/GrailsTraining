...
*****************grep******************
<g:grep in="${users.username}" filter="~/.*?al.*?/">
    <p>username: ${it}</p>
</g:grep>
...
<g:link controller="userManagement" action="list"><p>user List</p></g:link>


<g:link controller="userManagement" action="show" id="1"><p>user 1</p></g:link>


<g:link controller="userManagement" action="show" id="${user?.id}"><p>${user?.username}</p></g:link>


<g:link url="[action: 'list', controller: 'userManagement']"><p>user List</p></g:link>
...
<g:form name="myForm" controller="userManagement" action="save">
