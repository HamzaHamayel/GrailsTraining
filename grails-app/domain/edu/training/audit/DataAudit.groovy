 ...
 * under the License.
*/
package edu.training.audit

/**
 * DataAudits are reported to the AuditLog table.
 * This requires you to set up a table or allow
 * Grails to create a table for you. (e.g. DDL or db-migration plugin)
 */
class DataAudit implements Serializable {
    ...
    static mapping = {
        ...
        oldValue type: 'text',sqlType: "CLOB"
        newValue type: 'text',sqlType: "CLOB"
